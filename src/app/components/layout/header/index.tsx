              ...
              {user?.user || session?.user ? (
                ...
                <div className='flex items-center gap-2'>
                  <Link
                    ...
                    className="hidden lg:flex items-center justify-center w-12 h-12 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-all duration-200"
                  >
                    <img src="/images/logo/linkedin.svg" alt="LinkedIn" className="w-8 h-8" />
                  </Link>
                  <Link
                    href="https://www.instagram.com/athousand.voices/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hidden lg:flex items-center justify-center w-12 h-12 bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 rounded-full transition-all duration-200"
                  >
                    <img src="/images/logo/instagram.svg" alt="Instagram" className="w-8 h-8" />
                  </Link>
                </div>
              )}
                ...
                {user || session?.user ? (
                  ...
                  <>
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full flex items-center justify-center border border-dark_black dark:border-white text-primary px-4 py-2 rounded-md hover:bg-dark_black dark:hover:bg-white hover:text-white dark:hover:text-dark_black"
                    >
                      <img src="/images/logo/linkedin.svg" alt="LinkedIn" className="w-6 h-6" />
                    ...
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full flex items-center justify-center text-white dark:text-dark_black px-4 py-2 bg-dark_black dark:bg-white rounded-md hover:opacity-90"
                    >
                      <img src="/images/logo/instagram.svg" alt="Instagram" className="w-6 h-6" />
